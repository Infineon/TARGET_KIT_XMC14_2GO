...
#
# \brief
# Define the KIT_XMC14_2GO target.
#
################################################################################
# \copyright
...
MPN_LIST:=XMC1404-Q040x0200
DEVICE:=XMC1404-Q040x0200
DEVICE_COMPONENTS:=CAT3 XMC14XX
DEVICE_LIST:=XMC1404-Q040x0200
...
DEVICE_XMC1404-Q040x0200_CORES:=CORE_NAME_CM0_0
DEVICE_XMC1404-Q040x0200_DIE:=XMC1400
DEVICE_XMC1404-Q040x0200_FLASH_KB:=200
DEVICE_XMC1404-Q040x0200_SRAM_KB:=16
